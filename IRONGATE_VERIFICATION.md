...
**Last validated:** Wave 155v (J18 gate coupling: 3 install-base call sites migrated to `env_or()`; `mobility_phase` writes `gate-name` for NM hook identity bridge; 1281 tests, 0 clippy, 2026-07-31)
