...
**Last validated:** Wave 155r (J16 sources.toml garden self-enrollment: auto-provision includes Garden-category repos for self-CI; J13 depot freshness mesh publish via --publish flag; CSPRNG expect→Option propagation in BTSP; 1281 tests, 0 clippy, 2026-07-31)
