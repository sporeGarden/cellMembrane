...
**Last validated:** Wave 155u (Deep debt: `TargetArch` deprecated + `resolve_xdg_runtime_dir()` dedup + `UNKNOWN_LABEL` constant replaces 15 scattered `"unknown"` fallbacks; 1281 tests, 0 clippy, 2026-07-31)
