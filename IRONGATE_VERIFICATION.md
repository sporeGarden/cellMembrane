...
**Last validated:** Wave 155s (Registry API evolution: `require_capability`/`require_binary` collapse 6 redundant `.expect()` calls into structured panic methods; test hardened for dev-machine Neural API presence; 1281 tests, 0 clippy, 2026-07-31)
