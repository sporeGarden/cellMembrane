...
**Last validated:** Wave 155t (P2 platform detection fix: `detect_target_triple` rewired from legacy `TargetArch::detect_host` to `Platform::detect().triple()` — Windows cross-compiled binaries now report correct target triple; `TargetOs::detect` Android ordering fixed; unblocks J12; 1281 tests, 0 clippy, 2026-07-31)
