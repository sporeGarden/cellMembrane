...
```bash
cargo test                  # 917 tests — pedantic clippy clean
...
`GateTransport` methods (`is_tethered`, `is_local`). TOML roundtrip tests (gateway + TLS config). 917 tests, zero warnings.
