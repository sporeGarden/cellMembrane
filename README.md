...
```bash
cargo test                  # 1259 tests — pedantic clippy clean
...
| Code quality | 1259 tests, zero clippy warnings (pedantic), all files <800L | DONE |
...
1,259 tests cover types, manifest validation, dispatch, git_ops, cascade, plasmid,
